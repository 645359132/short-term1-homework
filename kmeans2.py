...
print(f" 碳排放特征：{emission_feature_dim}维（{sorted_years[0]}-{sorted_years[-1]}年）")
...
if not all(valid_2019_mask):
    ...
    double_dim_features = [f for f, m in zip(double_dim_features, valid_2019_mask) if m]
